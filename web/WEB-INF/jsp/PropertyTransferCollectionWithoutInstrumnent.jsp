...
<% String MSG = "";
    ...
    if (request.getAttribute("transfererName") != null) {
        transfererName = (String) request.getAttribute("transfererName");
    }
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="row_top">
                            ...
                            <% if (pf_ref_id.length() > 0) {%>
                            <div class="span6 labeltxt"> Property transfer without instrument id : <%=pf_ref_id%> <span id="sl_payment_taxNo" ></span></div>
                            ...
                            <div class="span6 labeltxt"> Date of notice : <%=dateOfNotice%><span id="sl_payment_propId" ></span></div>
                                <%--<input type="hidden" name="datOfNotice" path="datOfNotice" id="datOfNotice" value="<%=dateOfNotice%>" />--%>

                            <%}%>


                            <% if (transfererName.length() > 0) {%>


                            <div class="span6 labeltxt"> Transferee name :<%=transfererName%> <span id="sl_payment_propId" ></span></div>
                            ...
                            <div   style="display: none">
                                ...
                                <div class="span6 labeltxt"> Property transfer amount :<%=amount%> <span id="sl_payable_amount" ></span></div>
                                <input type="hidden" name="demandAmount" path="demandAmount" id="demandAmount" value="<%=amount%>" />
                            </div>
                        </div>
                        <% if (pf_ref_collection_id.length() > 0) {%>
                        <div class="span6 labeltxt"> Property transfer without instrument id : <%=pf_ref_collection_id%> <span id="sl_payment_taxNo" ></span></div>
                        ...
                        <form:form class="propertyTransferC"  modelAttribute="propertyTransferCollection" name="propertyTransferCollection" method="post" onsubmit="return validate();" action="propertyTransferCollectionWithoutInstrumentDataSave">
                            ...
                            <div class="form-group">
                                <div class="tableCellCol labeltxt">&nbsp;</div> 
                                <div class="tableCellCol labeltxt">
                                    <label class="labeltxt">Check/DD mumber <span style="color: red;">*</span></label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="tableCellCol labeltxt">
                                    ...
                                    <input type="text" id="cheque_dd_date" name="chequeDDDate" path="chequeDDDate" class="form-control1" placeholder="" >
                                </div>
                            </div>
                            <div class="clearfix"></div>
                            <div class="form-group"> 
...
<script>
    $(document).ready(function () {
        ...
        $("#cheque_dd_date").datepicker({dateFormat: 'yy-mm-dd'});
    });
    ...
    function validate() {
        ...
        if (sl_payment_amount == '') {
            ...
            if (payerName == '') {
                ...
                alert("conatct no. can't be left blank ");
                $("#contactNo").focus();
                return false;
            } else if (contactNo != '' && contactNo.length != 10) {
                alert("conatct no. must be number and must be 10 digit ");
                $("#contactNo").focus();
                return false;
            ...
            alert("Cheque or demand draft number can't be blank ");
            $("#cheque_dd_num").focus();
            ...
            alert("Bank name can't be blank ");
            $("#enc_banks").focus();
            $("#cheque_dd_num").attr("disabled", false);
            $("#cheque_dd_date").attr("disabled", false);
            $("#enc_banks").attr("disabled", false);
