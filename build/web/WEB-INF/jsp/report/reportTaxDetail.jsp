...
<script type="text/javascript" src="res/js/report/reportTaxDetail.js"></script>

<section class="cont" id="searchWindow">
    <div class="container-fluid contf" >
        <div class="row-fluid">
            <div class="propeh">Tax Detail</div>
            <div class="span12">
                <div class="span3">
                ...
                <div class="span3">
                    <div class="form-group">
                        <label class="labeltxt">Property Category: </label> 
                        <select id="rep_prop_cat" class="form-control">
                            <option value="-1">--Select Property Category--</option>
                        </select>
                    </div>
                </div>
                <div class="span3">
