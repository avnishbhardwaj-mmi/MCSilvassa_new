 ...
 */
//@Component("pdfView1")
public class PDFBuilder143Notice extends AbstractITextPdfNoticeView {
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document,
		...
		List<PrivateNoticeBean> beanList = (List<PrivateNoticeBean>) model.get("taxList");
                ...
                //String clientName="M/S Rayno Fastners Pvt Ltd.";
                //String address1="281/10-Gala No-105";
                //String address2="Amli Gala No-105";
                //String amount="32375";
                //String period="1994 to 2009.";
                String officer1="Shri. Anil Bhat, Silvassa (Municipal Engineer, Silvassa Municipal Council)";
                String officer2="Shri. Sunil Patel, Silvassa (Assistant Account Officer, Silvassa Municipal Council)";
                String pid="";
                String clientName="";
                String address1="";
                String address2="";
                String amount="";
                String period="up to 2018";
                ...
                Font fontEngH_6=new Font(Font.FontFamily.TIMES_ROMAN,11,Font.BOLD);
                ...
                int sno = 1;
                 ...
                 pid=bean.getUniqueId();
                  ...
                  PdfPTable table = new PdfPTable(6); // 3 columns.
                    ...
                    //cell1.setPaddingLeft(10);
                    cell17.setBorder(0);
                    cell17.setPhrase(new Phrase("_____________________________________________________________________________________ ",fontEngH_1 ));
                    ...
                    //cell1.setPaddingLeft(10);
                    cell18.setBorder(0);
                    cell18.setPhrase(new Phrase("No.SMC/CO/Acct/2018-19/471/ ",fontEngH_2 ));
                    ...
                    //cell1.setPaddingLeft(10);
                    cell22.setBorder(0);
                    cell22.setPhrase(new Phrase(" FORM OF WARRANT ",fontEngH_3));
                    ...
                    //cell1.setPaddingLeft(10);
                    cell25.setBorder(0);
                    cell25.setPhrase(new Phrase("(SECTION 143) ",fontEngH_4));
                    ...
                    //cell1.setPaddingLeft(10);
                    cell28.setBorder(0);
                    cell28.setPhrase(new Phrase("Whereas, "+clientName+" , residing at "+address1+"  has not paid and has not shown satisfactory cause for the non-payment of the sum of Rs. "+ df.format(Long.parseLong(amount))+"/- due against tax for the period from the year  " +period+"\nAnd whereas fifteen days have elapsed since the service on him of notice of demand for the same",fontEngH_5 ));
                    ...
                    //cell1.setPaddingLeft(10);
                    cell29.setBorder(0);
                    cell29.setPhrase(new Phrase("This is to command you to attach subject to the provisions of Section-143 of Dadra and Nagar Haveli Municipal Council Regulation, 2004 the goods and chattels property of "+clientName+" to the amount of Rs."+df.format(Long.parseLong(amount))+"/- being the amount due from him as follows:",fontEngH_5 ));
                    ...
                    table14.setWidths(columnWidths);
                    PdfPCell cell33 = new PdfPCell();
                    //cell1.setBorderColor(BaseColor.BLUE);
                    //cell1.setPaddingLeft(10);
                    cell33.setBorder(0);
                    cell33.setPhrase(new Phrase("On account of Property tax and Professional tax of Rs."+ df.format(Long.parseLong(amount))+"/-"+"\nFor the service of the notice : Rs. 25/- (R.P.A.D fees)\nFor issue of warrant : Rs. 500/-",fontEngH_5 ));
                    cell33.setHorizontalAlignment(Element.ALIGN_LEFT);
                    cell33.setVerticalAlignment(Element.ALIGN_MIDDLE);
                    cell33.setColspan(6);
                    cell33.setLeading(1.5f, 1.2f);
                    table14.addCell(cell33);
                    document.add(table14);
                    
                    document.add(new Paragraph(" "));
                    PdfPTable table15 = new PdfPTable(6);
                    table15.setWidths(columnWidths);
                    PdfPCell cell34 = new PdfPCell();
                    //cell1.setBorderColor(BaseColor.BLUE);
                    //cell1.setPaddingLeft(10);
                    cell34.setBorder(0);
                    cell34.setPhrase(new Phrase("And forthwith to certify to me together with this warrant all particulars of the goods to property attached by you thereunder.",fontEngH_5 ));
                    cell34.setHorizontalAlignment(Element.ALIGN_LEFT);
                    cell34.setVerticalAlignment(Element.ALIGN_MIDDLE);
                    cell34.setColspan(6);
                    cell34.setLeading(1.5f, 1.2f);
                    table15.addCell(cell34);
