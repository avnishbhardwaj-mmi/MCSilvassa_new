...
<script src="res/js/OffLineToOnLine.js" type="text/javascript"></script>
...
<section class="html_silvassa">
    <div class="container">      
        ...
        <div id="draggable_div" class="draggable_div ui-resizable col-sm-6 ui-widget-content">
        ...
        <p>* Mandatory.</p>
        <p>&radic; Tick the check box to change the fields.</p>
        <p>&block; Please fill in the details which need correction. Leave the rest unchanged.</p>
        ...
        <p ><img src="res/correction/images/please_text.jpg" alt="*कृपया केवल उस विवरण को भरें जिसे सुधार की आवश्यकता हैए बाकी सभी को रद्द करें।" >
            <br> </p>

        <form:form id="myform"  method="post" action="submitCorrectionForm" modelAttribute="correctionFormBean" enctype="multipart/form-data"  > 
