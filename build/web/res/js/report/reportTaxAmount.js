...
$(document).on("click", "#searchProp", function() {
    ...
    var minAmount = $("#sl_min_amount").val();
    var maxAmount = $("#sl_max_amount").val();
    if (obj.zone === "-1" || minAmount === "" || maxAmount === "") {
        alert("Kindly provide all inputs.");
    } else {
        obj.minTaxAmount = minAmount;
        obj.maxTaxAmount = maxAmount;
